...
3. 全局替换`velor2012`为仓库所有者ID; 全局替换`nonebot-plugin-reminder`为插件名; 全局替换`nonebot_plugin_reminder`为包名; 修改 python 徽标中的版本为你插件的运行所需版本
...
在 nonebot2 项目的根目录下打开命令行, 输入以下指令即可安装
    ...
    nb plugin install nonebot-plugin-reminder
...
<summary>pip</summary>
    ...
    pip install nonebot-plugin-reminder
</details>
<details>
<summary>pdm</summary>

    pdm add nonebot-plugin-reminder
</details>
<details>
<summary>poetry</summary>

    poetry add nonebot-plugin-reminder
</details>
<details>
<summary>conda</summary>

    conda install nonebot-plugin-reminder
</details>

打开 nonebot2 项目根目录下的 `pyproject.toml` 文件, 在 `[tool.nonebot]` 部分追加写入

    plugins = ["nonebot_plugin_reminder"]
